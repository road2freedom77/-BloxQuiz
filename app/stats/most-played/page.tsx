...
export const metadata = {
  title: "Most Played Roblox Games 2026 — Live Player Count Rankings | BloxQuiz",
  description:
    "The most played Roblox games right now ranked by live concurrent players. Updated hourly with real player counts, total visits, and historical data.",
  alternates: { canonical: "https://www.bloxquiz.gg/stats/most-played" },
  openGraph: {
    title: "Most Played Roblox Games 2026 — Live Player Count Rankings | BloxQuiz",
    description: "The most played Roblox games right now ranked by live concurrent players. Updated hourly.",
      ...
      <div style={{ minHeight: "100vh", background: "#0a0a14", color: "#fff", fontFamily: "'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif" }}>
        ...
        <div style={{ background: "linear-gradient(180deg, #0f0f23 0%, #0a0a14 100%)", borderBottom: "1px solid rgba(255,255,255,0.06)", padding: "48px 0 40px" }}>
          <div style={{ maxWidth: 1100, margin: "0 auto", padding: "0 20px" }}>
            ...
            <h1 style={{ fontSize: 36, fontWeight: 900, margin: "0 0 10px", lineHeight: 1.1 }}>
              🎮 Most Played Roblox Games {new Date().getFullYear()}
            </h1>
        ...
        <div style={{ maxWidth: 1100, margin: "0 auto", padding: "36px 20px 80px" }}>
          ...
          <div style={{ background: "#111827", border: "1px solid rgba(255,255,255,0.07)", borderRadius: 16, overflow: "hidden" }}>
            ...
            {games.map((game, i) => (
              <Link key={game.slug} href={`/stats/${game.slug}`} style={{ textDecoration: "none", color: "inherit", display: "block" }}>
                <div
                  className="stats-row"
                  style={{ display: "grid", gridTemplateColumns: "52px 1fr 140px 140px 120px", padding: "14px 20px", borderBottom: i < games.length - 1 ? "1px solid rgba(255,255,255,0.04)" : "none", alignItems: "center" }}
                >
          ...
          <div style={{ marginTop: 40, display: "flex", gap: 12, flexWrap: "wrap", justifyContent: "center" }}>
            <Link href="/stats/most-visited" style={{ background: "#111827", border: "1px solid rgba(255,255,255,0.07)", borderRadius: 12, padding: "12px 20px", textDecoration: "none", color: "rgba(255,255,255,0.7)", fontWeight: 600, fontSize: 14 }}>
              👁️ Most Visited Games
            </Link>
            <Link href="/stats/trending" style={{ background: "#111827", border: "1px solid rgba(255,255,255,0.07)", borderRadius: 12, padding: "12px 20px", textDecoration: "none", color: "rgba(255,255,255,0.7)", fontWeight: 600, fontSize: 14 }}>
              📈 Trending Games
            </Link>
            <Link href="/stats" style={{ background: "#111827", border: "1px solid rgba(255,255,255,0.07)", borderRadius: 12, padding: "12px 20px", textDecoration: "none", color: "rgba(255,255,255,0.7)", fontWeight: 600, fontSize: 14 }}>
              📊 All Stats
            </Link>
          </div>
        </div>
