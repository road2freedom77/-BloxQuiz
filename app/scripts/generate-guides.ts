...
const GAMES = [
  {
    ...
    name: "Blox Fruits",
    genre: "RPG / Adventure",
    guideSlug: "blox-fruits-beginners-guide",
    title: "Blox Fruits Beginner's Guide (2026) — How to Start, Level Up & Get Strong",
    difficulty: "Beginner",
  },
  {
    slug: "dress-to-impress",
    name: "Dress to Impress",
    genre: "Fashion / Social",
    guideSlug: "dress-to-impress-beginners-guide",
    title: "Dress to Impress Beginner's Guide (2026) — How to Win Rounds & Build Your Style",
    difficulty: "Beginner",
  },
  {
    ...
    genre: "Simulator",
    guideSlug: "bee-swarm-simulator-beginners-guide",
    title: "Bee Swarm Simulator Beginner's Guide (2026) — Hive Building, Quests & Progress",
    difficulty: "Beginner",
  },
  {
    slug: "doors",
    ...
    guideSlug: "doors-beginners-guide",
    title: "Doors Beginner's Guide (2026) — How to Survive Every Floor & Beat Every Entity",
    difficulty: "Beginner",
  },
  {
    slug: "murder-mystery-2",
    name: "Murder Mystery 2",
    genre: "Mystery / Social",
    guideSlug: "murder-mystery-2-beginners-guide",
    title: "Murder Mystery 2 Beginner's Guide (2026) — Roles, Strategies & Trading Tips",
    difficulty: "Beginner",
  },
];
