...
export default function TermsPage() {
  const sections = [
    ...
    },
    {
      ...
      content: "BloxQuiz participates in the Amazon Associates Program, an affiliate advertising program designed to provide a means for sites to earn advertising fees by advertising and linking to Amazon.com. When you click on certain links on BloxQuiz and make a purchase, we may earn a small commission at no additional cost to you. These links are clearly marked with 'rel=\"sponsored\"' attributes. We only link to products we believe are relevant to our users, such as Roblox gift cards."
    },
    {
