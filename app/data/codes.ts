export const LAST_UPDATED = "March 12, 2026";
...
export const ALL_CODES: GameCodes[] = [
  {
    ...
    codes: [
      ...
      { code: "Sub2Daigrock", reward: "2x EXP for 15 minutes", active: true },
      { code: "TantaiGaming", reward: "2x EXP for 15 minutes", active: true },
      { code: "StrawHatMaine", reward: "2x EXP for 15 minutes", active: true },
      { code: "TRIPLEFLASH", reward: "2x EXP for 20 minutes", active: false },
    ],
  },
  {
    game: "Brookhaven RP",
  ...
  },
  {
    ...
    codes: [
      { code: "SPROUT", reward: "Free Seed Pack", active: true },
  ...
  },
  {
    ...
    codes: [
      { code: "ARSENALSEASON10", reward: "Free skin", active: true },
  ...
  },
  {
    ...
    codes: [
      { code: "WeekendEXPCode", reward: "EXP boost", active: true },
      { code: "Dim2Soon", reward: "Chikara + Yen", active: true },
  ...
  },
  {
    ...
    codes: [
      { code: "77481867185789", reward: "Pink Preppy Summer outfit", active: true },
  ...
  },
  {
    ...
    codes: [
      { code: "FOURtunate", reward: "1x Marshmallow Bee, 4x Strawberries, 4x Seeds, 4x Gumdrops, 4x Field Dice", active: true, isNew: true },
      ...
      { code: "FrogFix", reward: "1x Gingerbread Bear, 1x Marshmallow Bee, 5x Wealth Clock Buff, Mountain Top Field Boost", active: true },
      { code: "ThreeBeeVee", reward: "1x Marshmallow Bee, 1x Loaded Dice, Mountain Top Field Boost x3", active: true },
      ...
      { code: "LatePresents", reward: "Misc. rewards", active: true },
    ],
  },
  {
    ...
    codes: [
      ...
      { code: "CUPIDSCLOUD", reward: "Cupid Cloud item", active: true },
      ...
      { code: "1CON1CF4TMA", reward: "Free outfit item", active: true },
      { code: "3NCHANTEDD1ZZY", reward: "Free accessory", active: true },
      { code: "ASHLEYBUNNI", reward: "Free outfit item", active: true },
      { code: "ANGELT4NKED", reward: "Free outfit item", active: true },
      { code: "B3APL4YS_D0L1E", reward: "Free outfit item", active: true },
      { code: "BELALASLAY", reward: "Free outfit item", active: true },
      { code: "C4LLMEHH4LEY", reward: "Free outfit item", active: true },
      { code: "CH00P1E_1S_B4CK", reward: "Free outfit item", active: true },
      { code: "D1ORST4R", reward: "Free outfit item", active: true },
      { code: "ELLA", reward: "Free outfit item", active: true },
      { code: "IBELLASLAY", reward: "Free outfit item", active: true },
      { code: "ITSJUSTNICHOLAS", reward: "Free outfit item", active: true },
      { code: "KREEK", reward: "Free outfit item", active: true },
      { code: "KITTYUUHH", reward: "Free outfit item", active: true },
      { code: "LABOOTS", reward: "Free outfit item", active: true },
      { code: "LANABOW", reward: "Lana Bow accessory", active: true },
      { code: "LANA", reward: "Free item", active: true },
      { code: "LANATUTU", reward: "Free outfit item", active: true },
      { code: "LEAHASHE", reward: "Free outfit item", active: true },
      { code: "M3RM4ID", reward: "Free outfit item", active: true },
      { code: "MEGANPLAYSBOOTS", reward: "Free boots", active: true },
      { code: "PIXIIUWU", reward: "Free outfit item", active: true },
      { code: "S3M_0W3N_Y4Y", reward: "Free outfit item", active: true },
      { code: "SUBM15CY", reward: "Free lashes", active: true },
      { code: "TEKKYOOZ", reward: "Free outfit item", active: true },
      { code: "UMOYAE", reward: "Free outfit item", active: true },
    ],
  },
  {
    game: "Livetopia",
  ...
  },
  {
    ...
    codes: [
      ...
      { code: "ADXREBOOT", reward: "Free Gems", active: true },
      { code: "ADXLAUNCH", reward: "Free Gems", active: true },
      { code: "ADXUPDATE", reward: "Free Gems", active: true },
      { code: "SORRYFORLAG", reward: "Free Gems", active: true },
      { code: "CHRISTMAS2024", reward: "Free Gems + Ancient Relics", active: true },
      { code: "HALLOWEEN2024", reward: "Free Gems", active: true },
      { code: "ANNIVERSARY", reward: "Free Gems + Tokens", active: true },
      { code: "THANKYOU100M", reward: "Free Gems", active: true },
      { code: "UPDATE5", reward: "Free Gems", active: true },
      { code: "UPDATE4", reward: "Free Gems", active: true },
      { code: "UPDATE3", reward: "Free Gems", active: true },
      { code: "UPDATE2", reward: "Free Gems", active: true },
      { code: "UPDATE1", reward: "Free Gems", active: true },
      { code: "LAUNCH", reward: "Free Gems", active: true },
      { code: "RELAUNCH", reward: "Free Gems", active: true },
      { code: "MAINTENANCE", reward: "Free Gems", active: true },
      { code: "BUGFIX", reward: "Free Gems", active: true },
      { code: "SHUTDOWN", reward: "Free Gems", active: true },
      { code: "SORRY", reward: "Free Gems", active: true },
      { code: "BIGUPDATE", reward: "Free Gems", active: true },
      { code: "MILESTONE", reward: "Free Gems + Tokens", active: true },
      { code: "COMMUNITY", reward: "Free Gems", active: true },
      { code: "DISCORD", reward: "Free Gems", active: true },
      { code: "ADXSEASON2", reward: "Free Gems + Ancient Relics", active: true },
    ],
  },
  {
    game: "Funky Friday",
