export default function PopularQuizzes() {
    const quizzes = [
        { game: "Blox Fruits", difficulty: "Hard", diffColor: "var(--neon-pink)", diffBg: "rgba(255,60,172,0.1)", questions: 15, title: "Ultimate Blox Fruits Expert Quiz", desc: "Can you name every Mythical fruit? Prove you're a true Blox Fruits master.", plays: "8.4K", rating: "4.8", thumb: "linear-gradient(135deg, #1a0a2e, #3d1a5c)", emoji: "🍎⚔️🌊", slug: "blox-fruits-ultimate" },
        { game: "Brookhaven", difficulty: "Easy", diffColor: "var(--neon-green)", diffBg: "rgba(0,245,160,0.1)", questions: 10, title: "Brookhaven Secrets You Didn't Know", desc: "Hidden locations, Easter eggs & secret cars. How many do you know?", plays: "12.1K", rating: "4.9", thumb: "linear-gradient(135deg, #0a1628, #1a3a5c)", emoji: "🏠🚗👨‍👩‍👧", slug: "brookhaven-secrets" },
        { game: "Adopt Me!", difficulty: "Medium", diffColor: "var(--neon-yellow)", diffBg: "rgba(255,227,71,0.1)", questions: 12, title: "Name That Pet! — Adopt Me Edition", desc: "From common to legendary — can you identify every pet from clues alone?", plays: "6.2K", rating: "4.7", thumb: "linear-gradient(135deg, #2a1a0a, #5c3a1a)", emoji: "🐶🦄🥚✨", slug: "adopt-me-pets" },
        { game: "All Games", difficulty: "Medium", diffColor: "var(--neon-yellow)", diffBg: "rgba(255,227,71,0.1)", questions: 20, title: "Which Roblox Game Are You?", desc: "Answer 20 personality questions and discover your perfect Roblox game match.", plays: "22.5K", rating: "4.9", thumb: "linear-gradient(135deg, #0a2818, #1a5c3a)", emoji: "🧠🎭❓", slug: "which-roblox-game" },
      ];
    ...
    return (
      <div id="quizzes" style={{ position: "relative", zIndex: 1 }}>
        ...
        <div style={{ maxWidth: 1200, margin: "0 auto", padding: "0 24px", display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(280px, 1fr))", gap: 16 }}>
          {quizzes.map((quiz) => (
            <a href={`/quiz/${quiz.slug}`} key={quiz.title} style={{ background: "var(--bg-card)", border: "1px solid var(--border)", borderRadius: "var(--radius)", overflow: "hidden", cursor: "pointer", textDecoration: "none", display: "block" }}>
