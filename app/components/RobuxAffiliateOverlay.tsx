...
export default function RobuxAffiliateOverlay() {
  ...
  if (variant === "gift-card-strip") return <ToyStrip onClick={handleClick} onDismiss={handleDismiss} />;
...
/* ─── VARIANT B: Toy Strip ─── */
function ToyStrip({ onClick, onDismiss }: { onClick: () => void; onDismiss: (e: React.MouseEvent) => void }) {
  return (
    <a href={AMAZON_URL} target="_blank" rel="noopener sponsored" onClick={onClick}
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
        ...
        <span>Roblox Figures &amp; Toys on Amazon — Phatmojo, Blox Fruits, Adopt Me</span>
      </div>
  ...
  return (
    <a href={AMAZON_URL} target="_blank" rel="noopener sponsored" onClick={onClick}
      ...
      <div>
        ...
        <div style={{ fontSize: 13, fontWeight: 900, lineHeight: 1.2 }}>Roblox Toys →</div>
      </div>
  ...
  return (
    <>
      <a href={AMAZON_URL} target="_blank" rel="noopener sponsored" onClick={onClick}
        ...
        <div style={{ width: 36, height: 36, borderRadius: "50%", background: "linear-gradient(135deg, #ffd700, #d4a017)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 18, flexShrink: 0, animation: "bubble-pulse 2s ease-in-out infinite" }}>🧸</div>
        <div>
          <div style={{ fontSize: 11, color: "#888", fontWeight: 700, lineHeight: 1.2 }}>Roblox Toys</div>
          <div style={{ fontSize: 13, fontWeight: 900, color: "#1a1a1a", lineHeight: 1.2 }}>Shop Amazon →</div>
        </div>
    ...
    <a href={AMAZON_URL} target="_blank" rel="noopener sponsored" onClick={onClick}
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
        ...
        <div>
          ...
          <div style={{ fontSize: 14, fontWeight: 900, lineHeight: 1.2 }}>Roblox Toys &amp; Figures →</div>
        </div>
      </div>
      ...
      <div style={{ position: "fixed", bottom: 0, left: 0, right: 0, zIndex: 9999, background: "#0f1a2e", borderRadius: "20px 20px 0 0", padding: "24px 24px 40px", animation: "slide-up 0.3s ease-out" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: 20 }}>
          ...
          <div style={{ fontSize: 14, color: "rgba(255,255,255,0.7)", fontWeight: 600, lineHeight: 1.6 }}>
            Phatmojo figures, Blox Fruits, Adopt Me toys and more — all on Amazon with free Prime shipping.
          </div>
        </div>
        <a href={AMAZON_URL} target="_blank" rel="noopener sponsored" onClick={onClick}
  ...
  return (
    <div style={{ position: "fixed", bottom: 80, left: 16, right: 16, zIndex: 9999, background: "linear-gradient(135deg, #1a2440, #0f1a2e)", border: "1px solid rgba(255,215,0,0.3)", borderRadius: 16, padding: "16px 20px", boxShadow: "0 8px 32px rgba(0,0,0,0.4)" }}>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
        <div style={{ width: 48, height: 48, borderRadius: 12, background: "linear-gradient(135deg, #ffd700, #d4a017)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 24, flexShrink: 0 }}>🧸</div>
        <div style={{ flex: 1 }}>
          ...
          <div style={{ fontSize: 14, fontWeight: 900, color: "#fff", lineHeight: 1.3, marginBottom: 2 }}>Roblox Toys &amp; Figures on Amazon</div>
