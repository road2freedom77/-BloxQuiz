export default function GameCategories() {
    const games = [
      { name: "Blox Fruits", quizzes: 42, icon: "⚔️", bg: "rgba(255,60,172,0.12)", badge: "🔥 Hot", badgeColor: "#FF3CAC", badgeBg: "rgba(255,60,172,0.15)", slug: "blox-fruits" },
      { name: "Brookhaven", quizzes: 28, icon: "🏠", bg: "rgba(0,217,255,0.12)", badge: null, slug: "brookhaven" },
      { name: "Adopt Me!", quizzes: 35, icon: "🐾", bg: "rgba(255,227,71,0.12)", badge: "📈 Trending", badgeColor: "#B84CFF", badgeBg: "rgba(184,76,255,0.15)", slug: "adopt-me" },
      { name: "Tower of Hell", quizzes: 18, icon: "🗼", bg: "rgba(0,245,160,0.12)", badge: null, slug: "tower-of-hell" },
      { name: "Grow a Garden", quizzes: 12, icon: "🌱", bg: "rgba(184,76,255,0.12)", badge: "✨ New", badgeColor: "#00F5A0", badgeBg: "rgba(0,245,160,0.15)", slug: "grow-a-garden" },
      { name: "Murder Mystery 2", quizzes: 22, icon: "🔫", bg: "rgba(255,138,71,0.12)", badge: null, slug: "murder-mystery-2" },
    ];
    ...
    return (
      <div id="games" style={{ position: "relative", zIndex: 1 }}>
        <div style={{ maxWidth: 1200, margin: "0 auto", padding: "48px 24px 24px", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          ...
          <a href="/browse" style={{ color: "var(--neon-green)", textDecoration: "none", fontWeight: 800, fontSize: 14 }}>View All 50+ →</a>
        </div>
