export default function Footer() {
  ...
  return (
    <>
      <footer style={{ maxWidth: 1200, margin: "60px auto 0", padding: "40px 24px", borderTop: "1px solid var(--border)", display: "grid", gridTemplateColumns: "2fr 1fr 1fr 1fr 1fr", gap: 40, position: "relative", zIndex: 1 }}>
        <div>
